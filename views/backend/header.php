...
<body class="bhd-transition sidebar-mini">
   <div class="wrapper">
      <nav class="main-header navbar navbar-expand navbar-white navbar-light">
         ...
         <ul class="navbar-nav ml-auto">
               ...
               <div class="navbar-search-block">
                  <form class="form-inline">
                     <div class="input-group input-group-sm">
                        <input class="form-control form-control-navbar" type="search" placebhder="Search" aria-label="Search">
            ...
            <li class="nav-item">
               <a class="nav-link" href="http://localhost/D1_Duong_2122110025/index.php" role="button">
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
         ...
         <div class="sidebar">
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
               <div class="image">
                  <img src="../public/images/user/<?= ($_SESSION['image']) ?? 'image.psd'; ?>" class="img-circle elevation-2" alt="<?= ($_SESSION['image']) ?? 'image.psd'; ?>">
