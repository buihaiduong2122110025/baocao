...
<div class="content-wrapper">
         <section class="content-header">
            <div class="container-fluid">
               <div class="row mb-2">
                  <div class="col-sm-12">
                  <strong class="text-dark text-lg">THÙNG RÁC LIÊN HỆ</strong>
                  </div>
               </div>   
            </div>
         </section>
                    ...
                    <th class="text-center" style="width:20px;">ID</th>
                          ...
                          <?php if(count($list) > 0) : ?>
                              ...
                              <td class="text-center">
                                 ...
                                 <td class="text-center">
                                 <a href="index.php?option=contact&cat=destroy&id=<?= $item->id; ?>" class="btn btn-sm btn-danger">
                                    <i class="fas fa-trash"></i>
                                 </a>
                                 <a href="index.php?option=contact&cat=restore&id=<?= $item->id; ?>" class="btn btn-sm btn-info">
