...
<form action="index.php?option=cart&updatecart=true" method="post" enctype="multipart/form-data">
      ...
      <div class="container">
         <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb py-2 my-0">
               ...
               <a class="text-main"  > Giỏ hàng của bạn</a>
               </li>
            </ol>
         </nav>
      </div>
      ...
      <div class="container">
         <table class="table table-bordered">
                     ...
                     <tr>
                        ...
                        <td class="text-center align-middle">
                           <div class="input-group mb-3">
                              <div class="input-group mb-3">
                                 <input type="number" value="<?= $cart['qty']; ?>" id="qty" min="0" name="qty[<?= $cart['id']; ?>]" style="width:70px;">
                              </div>
                           </div>
                        </td>
                        <td class="text-center align-middle">
            ...
            <tfoot>
               <tr>
                  <td colspan="5">
                     <button type="submit" class="btn btn-main " type="submit">Cập nhật</button>
