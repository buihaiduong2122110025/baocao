...
$list_topic = Topic::where('status', '=', 1)->orderBy('created_at', 'DESC')->skip($offset)->limit($limit)->get(); 
      ...
      <div class="row">
         ...
         <div class="col-md-9 order-1 order-md-2">
            <div class="category-title bg-main">
               <h3 class="fs-5 py-3 text-center">CHủ Đề bài Viết</h3>
            </div>
